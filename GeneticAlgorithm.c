...
//the speed of the program is dependent on the fitness function, so it is important to make it as fast as possible
//with the fitnessCalculator function below, the program can process 36,670,333 genes in 1 second (pop size 1000000, gene size 100 in 2.727s)
//but with the primeCalculator function below, the program can only process 455 genes in 1 second (pop size 100, gene size 7 in 1.536s)
...
//__________Example Main__________
// int main(){
//     int pop = 100;
//     int minGeneValue = 0;
//     int maxGeneValue = 9;
